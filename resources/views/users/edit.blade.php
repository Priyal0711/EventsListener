                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td class="inpt" colspan="2">
                                <input type="text" placeholder="State" name="state" id="state" value="{{ $data->state }}">
                            </td>
                        </tr>
                        <tr>
                            <td class="inpt" colspan="2">
                                <input type="text" placeholder="User Name" name="user_name" id="user_name" value="{{ $data->user_name }}">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
